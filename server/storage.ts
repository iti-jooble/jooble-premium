    ...
    experience: [
      {
        ...
        endYear: null,
        description:
          "Leading front-end development team, implementing React applications.",
        isCurrent: true,
      },
    ],
    templateId: 1,
    ...
    experience: [
      {
        ...
        endYear: null,
        description:
          "Leading design projects for major clients, conducting user research and creating prototypes.",
        isCurrent: true,
      },
    ],
    templateId: 2,
...
export const storage: IStorage = {
  ...
  getAISuggestion: async (section: string, additionalContext?: string) => {
    ...
    switch (section) {
      ...
      case "skills":
        suggestion =
          "Project Management, Strategic Planning, Team Leadership, Stakeholder Communication, Budget Oversight";
        break;
      default:
        suggestion =
          "Expert in " +
          section +
          " with demonstrated ability to drive results.";
    }
