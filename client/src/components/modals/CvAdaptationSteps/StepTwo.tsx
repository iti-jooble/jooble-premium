  ...
  return (
    <div className="flex flex-col h-full">
      <div className="mb-6 text-center">
        <h2 className="text-2xl font-bold mb-2">A few questions to adapt your resume for this job</h2>
        <p className="text-gray-600">It'll help highlight what makes you the right match.</p>
      </div>
      ...
      <div className="space-y-4 mb-8">
        {questions.map((question) => (
          <div key={question.id} className="bg-gray-50 rounded-lg p-4">
            <div className="mb-2">
              <p className="font-semibold text-gray-900 mb-1">{question.text}</p>
              {question.note && (
            ...
            <div className="flex justify-end space-x-2 mt-3">
              <Button 
                ...
                size="sm"
                className={`rounded-full w-12 h-12 p-0 ${question.answer === true ? 'bg-blue-500 text-white' : 'bg-white text-gray-500 hover:bg-gray-100'}`}
              ...
              <Button 
                ...
                size="sm"
                className={`rounded-full w-12 h-12 p-0 ${question.answer === false ? 'bg-blue-500 text-white' : 'bg-white text-gray-500 hover:bg-gray-100'}`}
            ...
            <div className="flex justify-end mt-1">
              <span className={`text-sm ${question.answer === true ? 'text-blue-500' : question.answer === false ? 'text-blue-500' : 'text-transparent'}`}>
                {question.answer === true ? 'Yes' : question.answer === false ? 'No' : '.'}
              </span>
            </div>
          </div>
        ))}
