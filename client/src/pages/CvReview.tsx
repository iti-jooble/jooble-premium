  ...
  return (
    <div className="p-6 sm:p-8 animate-in fade-in duration-300 bg-gradient-to-b from-background to-muted/20">
      <div className="mb-8 max-w-3xl">
        <h1 className="text-3xl font-bold tracking-tight text-primary-foreground">CV Review</h1>
        <p className="text-muted-foreground mt-2">Get instant feedback on your CV with our AI-powered review system</p>
      </div>
      ...
      <Card className="shadow-md border-border/30 border rounded-xl overflow-hidden bg-card">
        <CardContent className="p-8 flex flex-col items-center justify-center text-center">
          ...
          <h2 className="text-2xl font-semibold mb-3">Upload Your CV for Review</h2>
      ...
      <div className="mt-10">
        <h2 className="text-2xl font-semibold mb-6 text-primary-foreground/90">What We Check</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            ...
            <Card key={index} className="shadow-md border-border/30 border rounded-xl overflow-hidden transition-all hover:shadow-lg">
