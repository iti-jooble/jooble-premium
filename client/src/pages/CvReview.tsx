    ...
    <div className="p-6 sm:p-8 animate-in fade-in duration-300 bg-gradient-to-b from-background to-muted/20">
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div className="max-w-2xl">
          ...
          <p className="text-muted-foreground mt-2">{t("cvReview.subtitle")}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          <Card className="shadow-md border-border/30 border rounded-xl overflow-hidden bg-card/80 text-center">
            <CardContent className="p-6 pt-8">
              ...
              <p className="text-muted-foreground">
                CVs optimized with our analyzer are 93% more likely to pass ATS
                filters
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-md border-border/30 border rounded-xl overflow-hidden bg-card/80 text-center">
            <CardContent className="p-6 pt-8">
              ...
              <p className="text-muted-foreground">
                Users report up to 65% more interview invitations after
          ...
          <Card className="shadow-md border-border/30 border rounded-xl overflow-hidden bg-card/80 text-center">
            <CardContent className="p-6 pt-8">
              ...
              <p className="text-muted-foreground">
                Our keyword analysis helps align your CV with specific job
                requirements
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-md border-border/30 border rounded-xl overflow-hidden bg-card/80 text-center">
            <CardContent className="p-6 pt-8">
              ...
              <p className="text-muted-foreground">
                We check over 40 critical factors that impact recruiter and ATS
                assessments
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    We analyze how ATS systems parse your CV, ensuring critical
                    information is correctly extracted. This increases your
                    chances of passing initial screenings by up to 75%.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Recruiters spend an average of 7 seconds scanning a CV. We
                    ensure your formatting makes key information instantly
                    visible and creates a professional impression.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Our industry-specific keyword analysis identifies missing
                    terms that both ATS systems and recruiters look for,
                    increasing your match rate for relevant positions.
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    We analyze how well your CV demonstrates measurable impact
                    rather than just listing responsibilities.
                    Achievement-focused CVs are 52% more likely to generate
                    interview calls.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    We evaluate how well your skills align with your target
                    roles and provide suggestions to highlight the most valuable
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    We assess how clearly your CV demonstrates your professional
                    growth and readiness for your target role, helping you
