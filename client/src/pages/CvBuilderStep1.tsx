      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="w-full lg:w-2/5">
          ...
          >
            ...
            <AccordionItem
              value="personal"
              className="bg-white rounded-md shadow-sm border mb-3"
            >
        ...
        {/* Right side - Preview */}
        <div className="w-full lg:w-3/5 bg-gray-100 rounded-md">
              ...
              <div className="w-full md:w-1/3 bg-blue-50 p-4">
                <div className="mb-6">
                  ...
                  <div className="text-sm space-y-1.5">
                    <div className="flex items-center text-gray-600">
                      ...
                      <span>
                        {form.watch("email") || "john.doe@example.com"}
                      </span>
                    </div>
                    <div className="flex items-center text-gray-600">
                    ...
                    <div className="flex items-center text-gray-600">
                      ...
                      <span>
                        {form.watch("city") || "Paris"},{" "}
                        {form.watch("country") || "France"}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-xs text-gray-600 leading-relaxed">
                    Experienced driver with excellent navigation skills.
                    Committed to providing safe and efficient transportation
                    services. Strong attention to detail and ability to handle
              ...
              <div className="w-full md:w-2/3 p-6">
                <div className="mb-4">
                  <h1 className="text-lg font-semibold text-gray-800">
                    {form.watch("firstName") || "Alyson"}{" "}
                    {form.watch("lastName") || "Lawrence"}
                  </h1>
                </div>
