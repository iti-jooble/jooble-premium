...
import { MailIcon, FileTextIcon, CopyIcon, DownloadIcon, FileIcon, PencilIcon } from "lucide-react";
  ...
  return (
    <div className="p-6 sm:p-8 animate-in fade-in duration-300 bg-gradient-to-b from-background to-muted/20">
      <div className="mb-8 max-w-3xl">
        <h1 className="text-3xl font-bold tracking-tight text-primary-foreground">Cover Letter Creator</h1>
        <p className="text-muted-foreground mt-2">Generate personalized cover letters in minutes</p>
      </div>
      ...
      <Card className="shadow-md border-border/30 border rounded-xl overflow-hidden bg-card mb-10">
        <CardContent className="p-8 flex flex-col items-center justify-center text-center">
          ...
          <h2 className="text-2xl font-semibold mb-3">Create a New Cover Letter</h2>
      ...
      <h2 className="text-2xl font-semibold mb-6 text-primary-foreground/90">Cover Letter Templates</h2>
        ...
        <TabsContent value="professional">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <Card key={index} className="shadow-md border-border/30 border rounded-xl overflow-hidden group transition-all hover:shadow-lg">
                <div className="h-48 bg-muted/40 flex items-center justify-center relative">
                  ...
                  <div className="absolute inset-0 bg-black/10 backdrop-blur-sm opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
                    <Button variant="secondary" size="sm" className="shadow-lg">Preview</Button>
                  </div>
                </div>
                <CardContent className="p-5">
                  <h3 className="font-medium text-lg mb-2">{template.title}</h3>
                  <p className="text-muted-foreground mb-4">{template.description}</p>
                  <Button size="sm" variant="outline" className="w-full transition-all hover:border-primary/70">Use Template</Button>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <TabsContent value="creative">
          <div className="flex items-center justify-center p-16 bg-card/50 rounded-lg border border-border/30">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Select the Creative tab to view creative cover letter templates</p>
            </div>
          </div>
        </TabsContent>
        ...
        <TabsContent value="modern">
          <div className="flex items-center justify-center p-16 bg-card/50 rounded-lg border border-border/30">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Select the Modern tab to view modern cover letter templates</p>
            </div>
          </div>
        </TabsContent>
        ...
        <TabsContent value="simple">
          <div className="flex items-center justify-center p-16 bg-card/50 rounded-lg border border-border/30">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Select the Simple tab to view simple cover letter templates</p>
            </div>
          </div>
        </TabsContent>
      </Tabs>

      <h2 className="text-2xl font-semibold mb-6 text-primary-foreground/90">Recent Cover Letters</h2>
        ...
        <div className="divide-y divide-border/40">
          <div className="px-6 py-5 flex items-center hover:bg-muted/10 transition-colors">
            ...
            <div className="flex-1">
              <p className="font-medium text-foreground">Product Manager at TechCorp</p>
              <p className="text-sm text-muted-foreground mt-1">Created on Sep 28, 2023</p>
            </div>
          ...
          <div className="px-6 py-5 flex items-center hover:bg-muted/10 transition-colors">
            ...
            <div className="flex-1">
              <p className="font-medium text-foreground">Software Engineer at DevInc</p>
              <p className="text-sm text-muted-foreground mt-1">Created on Sep 15, 2023</p>
            </div>
            <div className="flex space-x-3">
              <Button variant="ghost" size="icon" className="h-9 w-9 rounded-full hover:bg-primary/10 hover:text-primary">
                <CopyIcon className="h-4.5 w-4.5" />
